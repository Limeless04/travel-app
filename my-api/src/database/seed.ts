...
import { Like } from 'src/entities/like.entity'; // Adjust the import path as necessary
...
async function bootstrap() {
  ...
  try {
    ...
    await dataSource.query('TRUNCATE TABLE "articles" RESTART IDENTITY CASCADE;');
    await dataSource.query('TRUNCATE TABLE "users" RESTART IDENTITY CASCADE;'); // Users
    ...
    const user1 = userRepository.create({
      ...
      password_hash: "$2y$10$l4fqvKboAmzE4WTKQTkjB.ySctGUbpaTQnCSRjJcOR3PojqNorFuO"
    ...
    const article1 = articleRepository.create({
      id: 1,
      title: "Exploring Bali's Hidden Waterfalls: A Guide to Nungnung and Sekumpul",
      slug:"exploring-balis-hidden-waterfalls-a-guide-to-nungnung-and-sekumpul",
      summary: "Discover the breathtaking beauty of Bali's lesser-known waterfalls...",
      content: "Bali, the Island of Gods, is renowned for its vibrant culture...",
      image_url: "https://plus.unsplash.com/premium_photo-1677829177642-30def98b0963?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      total_likes: 125,
    ...
    const article2 = articleRepository.create({
      id: 2,
      title: "A Foodie's Guide to Yogyakarta: Best Street Food and Local Delights",
      ...
      content: "Yogyakarta, the cultural heart of Java, is not just about ancient temples...",
      image_url: "https://images.unsplash.com/photo-1630214801769-24784bfd2b9c?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      total_likes: 98,
    ...
    const comment2 = commentRepository.create({
      id: 2,
      content: "Sekumpul looks incredible, definitely adding it to my itinerary!",
      article: article1,
    ...
    const comment3 = commentRepository.create({
      id: 3,
      content: "Gudeg is my absolute favorite! This guide makes me miss Yogyakarta.",
      article: article2,
