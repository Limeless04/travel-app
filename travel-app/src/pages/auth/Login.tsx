...
const Login = () => {
  ...
  const { login, loading, error, message, statusCode, clearMessages } =
    useAuthStore();
  ...
  useEffect(() => {
    if (expired) {
      setShowAlert(true);
      // Remove the 'expired' param from URL after showing modal
      searchParams.delete("expired");
      setSearchParams(searchParams, { replace: true });
    }
  }, [expired, searchParams, setSearchParams]);
